...
const Input = ({
  ...
  const inputContainerStyles = StyleSheet.flatten([
    {
      ...
      ...(inputBoxBgColor && {backgroundColor: inputBoxBgColor}),
      ...(inputBoxborderWidth && {backgroundColor: 0}),
    },
  ]) as ViewStyle;
  ...
  const inputStyles = StyleSheet.flatten([
    {
      ...
      ...(inputBoxHeight && {height: inputBoxHeight}),
    },
  ]) as TextStyle;
  ...
  return (
    <Block flex={0} style={inputBoxStyles} color={colors.transparent}>
      {label && (
